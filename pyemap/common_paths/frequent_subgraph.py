...
class FrequentSubgraph():
    '''
    Stores all information regarding a class of protein subgraphs.

    Attributes
    ----------
    id: str
        Unique identifier for class of subgraphs. 
    file_id: str
        Unique identifier where `#'s are swapped out for `NP's
    generic_subgraph: :class:`networkx.Graph`
        Graph representation of this class of subgraphs 
    support: list of str
        List of PDB IDs which contain this subgraph
    protein_subgraphs: dict str: :class:`networkx.Graph`
        Dict which contains protein subgraphs which match this class of subgraphs. Each entry has a unique identifier and a
        :class:`networkx.Graph` derived from the graphs generated by the :class:`~pyemap.emap` class which match 
        the pattern of this class of subgraphs.
    groups: dict of str: list of :class:`networkx.Graph`
        Protein subgraphs clustered into groups
    support_number: int
        Number of PDBs this class of subgraphs was identified in 
    ...
    def __init__(self, G, graph_number, support, res_to_num_label, edge_thresholds):
        ...
        G: :class:`networkx.Graph`
            Graph representation of this class of subgraphs 
        graph_number: int
            Unique numerical ID for this class of subgraphs
        support: list of str
            List of PDB IDs which contain this subgraph
    ...
    def general_report(self):
        ''' Generates general report which describes this class of subgraphs.

        Returns
        --------
        full_str: str
            General report which describes this class of subgraphs
    ...
    def find_protein_subgraphs(self,clustering_option="structural"):
        ...
        at any time by calling :func:`pyemap.common_paths.frequent_subgraph.FrequentSubgraph.set_clustering` and specifying the 
    ...
    def set_clustering(self,clustering_option):
        ...
        Notes
        ------
        Since both types of clustering are always computed by :func:`pyemap.common_paths.frequent_subgraph.FrequentSubgraph.find_protein_subgraphs`
    ...
    def _generate_protein_subgraph(self, mapping, protein_graph, generic_subgraph, emap_obj):
        ...
        generic_subgraph: :class:`networkx.Graph`
            Graph corresponding to class of subgraphs
